...
public class ListMovieByDirectorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_movie_by_director);
        Intent intent = getIntent();
        String newText= intent.getStringExtra("nameDirector");
        idCus=saveID.getId(ListMovieByDirectorActivity.this);
        tvNameDirector=findViewById(R.id.tvNameDirector);
        tvNameDirector.setText(newText);
        initData(newText,idCus);
    }
    private void initData(String text, int id) {

        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 3);
        recyclerView = findViewById(R.id.rvMovieByDirectorDetail);
        ...
        Call<HomeContentDto> call = service.getMovieByDirector(text, id);
        call.enqueue(new Callback<HomeContentDto>() {
            ...
            public void onResponse(Call<HomeContentDto> call, Response<HomeContentDto> response) {
                if(response.isSuccessful()){
                    ...
                    ListMovieByCategoryAdapter listMovieByCategoryAdapter = new ListMovieByCategoryAdapter(ListMovieByDirectorActivity.this,listMovie );
    ...
    public void onMessageEvent(ListMovieByCategoryAdapter.ClickItemMovie event) {
        ...
        Intent intent = new Intent(ListMovieByDirectorActivity.this, DetailActivity.class);
