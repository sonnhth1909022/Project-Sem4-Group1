...
public class ListMovieByCastActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    List<MovieDto> listMovie = new ArrayList<>();
    List<Cast> castList = new ArrayList<>();
    SaveID saveID = new SaveID();
    int idCus;
    TextView tvNameActor, tvDesActor;
    List<String> listDesActor = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_movie_by_cast);
        tvNameActor =findViewById(R.id.tvNameCast);
        Intent intent = getIntent();
        String newText= intent.getStringExtra("nameCast");
        idCus=saveID.getId(ListMovieByCastActivity.this);
        tvNameActor.setText(newText);
        initData(newText,idCus);
    }
    private void initData(String text, int id) {

        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 3);
        recyclerView = findViewById(R.id.rvMovieByCastDetail);
        ...
        Call<HomeContentDto> call = service.getMovieByCast(text,id);
        call.enqueue(new Callback<HomeContentDto>() {
            ...
            public void onResponse(Call<HomeContentDto> call, Response<HomeContentDto> response) {
                if(response.isSuccessful()){
                    ...
                    ListMovieByCategoryAdapter listMovieByCategoryAdapter = new ListMovieByCategoryAdapter(ListMovieByCastActivity.this,listMovie );
    ...
    public void onMessageEvent(ListMovieByCategoryAdapter.ClickItemMovie event) {
        ...
        Intent intent = new Intent(ListMovieByCastActivity.this, DetailActivity.class);
