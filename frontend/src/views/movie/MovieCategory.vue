    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            ></multiselect>
                        ...
                        <span class="input-group-text border-0" id="search-addon" @click="getMovieByCategory();">
...
export default {
    ...
    methods: {
        ...
        getRequestName(searchCategory , page , pageSize)
       {
          let params = {};
          if(searchCategory)
          {
        ...
        getMovieByCategory()
        {
            ...
            MovieService.getMovieByCategory(params).then(response => {
